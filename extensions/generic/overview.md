# ${{ task }} for Azure DevOps Server

This extension will install the ${{ task }} into your Azure DevOps Server.
...
You will need to [install a recent agent (2.195.0 or newer) from the azure-pipelines-agent repository](https://github.com/microsoft/azure-pipelines-agent/releases).
